...
public class CalcCostTest { // SER316 TASK 2 SPOTBUGS FIX - renamed class
    ...
    public void setUp() throws Exception {
        cart1 = new Cart(40); // Empty
        cart2 = new Cart(20); // Dairy, also underage
        cart3 = new Cart(40); // Meat
        cart4 = new Cart(40); // Produce
        cart5 = new Cart(40); // Alcohol
        cart6 = new Cart(20); // underage
        cart7 = new Cart(40); // frozen food only
        cart8 = new Cart(40); // one of each
        cart9 = new Cart(40); // 2 produce
        cart10 = new Cart(40); // 3 produce
        cart11 = new Cart(40); // 4 produce
        cart12 = new Cart(40); // all deals -> 3 produce, 1 of everything else
        cart13 = new Cart(21); // just of age
        cart14 = new Cart(22); // 2 alcohol, 2 frozen food
        cart15 = new Cart(22); // 2 alcohol, 1 frozen food
        cart16 = new Cart(23); // 1 alcohol, 2 frozen food
        cart17 = new Cart(40); // 6 produce
        cart18 = new Cart(20); // underage, 1 alcohol, 1 frozen
